...
import com.mac190.maxmin.MaxMin;

public class MaxMinPrimeTester {
    //create a default MaxMin M1
    MaxMinPrime M1 = new MaxMinPrime();
    ...
    //set min to 10
        M1.setMin(10);
        System.out.println("M1: " + M1);
    MaxMinPrime M2 = new MaxMinPrime(5, 1);
    ...
    MaxMinPrime M3 = MaxMinPrime.add(M1, M2);
